                                ...
                                return (
                                    <li className="nav-item dropdown pe-3">
                                        <a className="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                                            ...
                                            <span className="d-none d-md-block dropdown-toggle ps-2">{localStorage.getItem('adminname')}</span>
                                        </a>{/* End Profile Iamge Icon */}
                                        <ul className="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                                            <li className="dropdown-header">
                                                <h6>{localStorage.getItem('adminusername')}</h6>
                ...
                <ul className="sidebar-nav" id="sidebar-nav">
                        ...
                        <ul id="forms-nav" className="nav-content collapse " data-bs-parent="#sidebar-nav">
                            ...
                            <li>
                                <NavLink to="/addtestimonial">
                                    <i className="bi bi-circle" /><span>Add Testimonial</span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to="/form_editor">
                                    <i className="bi bi-circle" /><span>Form Editors</span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to="/form_validation">
                    ...
                    <li className="nav-item">
                        ...
                        <ul id="tables-nav" className="nav-content collapse " data-bs-parent="#sidebar-nav">
                            <li>
                                <NavLink to="/general_table">
                                    <i className="bi bi-circle" /><span>General Tables</span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to="/user_table">
                                    <i className="bi bi-circle" /><span>User Tables</span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to="/contact_table">
                                    <i className="bi bi-circle" /><span>Contact Tables</span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to="/product_table">
                                    <i className="bi bi-circle" /><span>Product Tables</span>
                                </NavLink>
                            </li>
                            <li>
                                <NavLink to="/testimonial_table">
                                    <i className="bi bi-circle" /><span>Testimonial Tables</span>
                                </NavLink>
                            </li>
                        </ul>
                    </li>{/* End Tables Nav */}
